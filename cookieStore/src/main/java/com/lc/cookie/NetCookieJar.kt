...
class NetCookieJar(private val cookieHandler: CookieHandler): CookieJar {
    ...
    private val STANDARD_DATE_FORMAT = SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss 'GMT'", Locale.US).apply {
        isLenient = false
    ...
    private fun Date.toHttpDateString(): String = STANDARD_DATE_FORMAT.format(this)
